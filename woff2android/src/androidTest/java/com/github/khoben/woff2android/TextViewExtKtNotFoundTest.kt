...
class TextViewExtKtNotFoundTest : BaseTest() {
    ...
    fun woff2TypefaceAssets() {
        ...
        sampleTextView.woff2Typeface(assets, "fail")
        Assert.assertEquals(sampleTextView.typeface, Typeface.DEFAULT)
    }
    ...
    fun woff2TypefacePath() {
        Assert.assertEquals(sampleTextView.typeface, Typeface.DEFAULT)
        sampleTextView.woff2Typeface("fail")
        Assert.assertEquals(sampleTextView.typeface, Typeface.DEFAULT)
    }
    ...
    fun woff2TypefaceFile() {
        Assert.assertEquals(sampleTextView.typeface, Typeface.DEFAULT)
        sampleTextView.woff2Typeface(File("fail"))
        Assert.assertEquals(sampleTextView.typeface, Typeface.DEFAULT)
    }
    ...
    fun testWoff2TypefaceBytes() {
        Assert.assertEquals(sampleTextView.typeface, Typeface.DEFAULT)
        sampleTextView.woff2Typeface(byteArrayOf())
        Assert.assertEquals(sampleTextView.typeface, Typeface.DEFAULT)
    }
}